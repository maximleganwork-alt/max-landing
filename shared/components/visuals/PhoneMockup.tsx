...
const sequence: Step[] = [
  { kind: "text", from: "user", text: "Запишите на завтра в 18:00 ✂️", time: "14:21" },
  { kind: "typing" },
  {
    kind: "text",
    from: "bot",
    text: "Свободно у Антона. Подтвердить запись?",
    time: "14:21",
  },
  { kind: "text", from: "user", text: "Да, подтверждаю", time: "14:22" },
  { kind: "typing" },
  {
    kind: "payment",
    title: "Запись #2087",
  ...
  },
  {
    kind: "text",
    from: "bot",
    text: "Готово! Напомним за час до визита 🔔",
    time: "14:23",
  },
];
