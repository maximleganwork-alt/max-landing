        ...
        >
          <defs>
            <linearGradient id="connectorGrad" x1="0" y1="0" x2="1" y2="0">
              ...
              <stop offset="100%" stopColor="var(--brand-grad-to)" stopOpacity="0.85" />
            </linearGradient>
          </defs>
          <path
            d="M2 9 Q 40 0 76 8"
...
export function Services({ title, lead, items, cta }: ServicesContent) {
  return (
    <section id="services" aria-labelledby="services-heading" className="section-padding section-diagonal-bg">
      <div className="container-narrow">
        ...
        <AnimateIn>
          <SectionHeading titleId="services-heading" title={title} lead={lead} />
        </AnimateIn>
