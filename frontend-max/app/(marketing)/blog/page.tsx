...
const PAGE_TITLE = "Блог о разработке ботов для MAX";
const PAGE_DESCRIPTION =
  "Разбираем популярные вопросы по разработке ботов в национальном мессенджере MAX: API, оплата, рассылки, интеграции с CRM и 1С.";
    ...
    <>
      ...
      <main id="main" className="pt-[calc(var(--header-height)+32px)]">
        <BlogIndex
          ...
          lead="Популярные вопросы по разработке, интеграциям и запуску ботов в национальном мессенджере MAX."
        />
      </main>
